  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox again - A dynamic marketplace bridging the gap between innovative freelancers and companies offering exciting job opportunities."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox again - A dynamic marketplace bridging the gap between innovative freelancers and companies offering exciting job opportunities.`}
            </Text>
            <Box
